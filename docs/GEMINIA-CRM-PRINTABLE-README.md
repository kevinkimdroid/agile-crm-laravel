Agile Craft CRM (Laravel) — Overview for stakeholders
...
Option A — Open the HTML version in Word (recommended)
  1. In File Explorer, open: docs\AGILE CRAFT-CRM-FOR-WORD.html
...
Project: Agile Craft CRM (Laravel application)
Compared to: Legacy Agile Craft CRM (Vtiger: PHP, Smarty, vtiger MySQL database)
...
---
Document: Agile Craft CRM — Laravel. Content reflects the repository as of the last update to this file.
