...
```apache
Alias /crm-client-feedback /var/www/agile-crm-laravel/crm-client-feedback
<Directory /var/www/agile-crm-laravel/crm-client-feedback>
    AllowOverride None
    Require all granted
...
location /crm-client-feedback {
    alias /var/www/agile-crm-laravel/crm-client-feedback;
    index index.php;
...
location ~ ^/crm-client-feedback/index\.php {
    ...
    fastcgi_param SCRIPT_FILENAME /var/www/agile-crm-laravel/crm-client-feedback/index.php;
}
```
