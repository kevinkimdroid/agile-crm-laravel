        ...
        <aside class="app-sidebar" id="appSidebar">
            ...
            <nav class="app-sidebar-nav">
                ...
                <div class="app-nav-group">
                    ...
                    <a href="{{ Route::has('marketing.campaigns') ? route('marketing.campaigns') : route('marketing.campaigns.index') }}" class="app-nav-link app-nav-sublink {{ request()->routeIs('marketing.campaigns') || request()->routeIs('marketing.campaigns.*') ? 'active' : '' }}">
