            ...
            <tr class="{{ $isInactive ? 'table-secondary' : '' }}">
                ...
                <td class="col-dept">
                    ...
                    <form id="dept-form-{{ $user->id }}" action="{{ route('settings.users.update-department', $user->id) }}" method="POST" class="d-inline-flex align-items-center gap-2" style="flex-wrap:nowrap">
                        ...
                        <button type="submit" form="dept-form-{{ $user->id }}" name="save_dept" value="1" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px;padding:.25rem .65rem;white-space:nowrap">Save</button>
                    </form>
                    @else
                ...
                <td class="col-reporting">
                    ...
                    <form id="reporting-form-{{ $user->id }}" action="{{ route('settings.users.update-reporting-manager', $user->id) }}" method="POST" class="d-inline-flex align-items-center gap-2" style="flex-wrap:nowrap">
                        ...
                        <button type="submit" form="reporting-form-{{ $user->id }}" name="save_reporting" value="1" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px;padding:.25rem .65rem;white-space:nowrap">Save</button>
                    </form>
                    @else
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        @else
                            ...
                            <form id="role-form-{{ $user->id }}" action="{{ route('setup.users.update-role') }}" method="POST" class="d-inline-flex align-items-center gap-2">
                                ...
                                <button type="submit" form="role-form-{{ $user->id }}" name="save_role" value="1" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px">Save</button>
                            </form>
