        ...
        <div class="card p-4">
            <div class="mb-4">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:var(--agile-primary-muted);color:var(--agile-primary)">
