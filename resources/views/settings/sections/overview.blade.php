...
.settings-overview-title { font-size: 1.25rem; font-weight: 600; color: var(--agile-text); margin: 0 0 0.35rem; }
.settings-overview-desc { font-size: 0.95rem; color: var(--agile-text-muted); margin: 0; }
...
.settings-overview-card {
    ...
    border-radius: 12px; text-decoration: none; color: var(--agile-text);
...
.settings-overview-icon {
    ...
    color: var(--agile-primary); font-size: 1.35rem; margin-bottom: 1rem;
}
...
.settings-overview-hint { font-size: 0.85rem; color: var(--agile-text-muted); line-height: 1.4; }
