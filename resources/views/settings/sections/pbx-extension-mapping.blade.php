<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        <button type="button" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px" data-bs-toggle="modal" data-bs-target="#addMappingModal">
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0 settings-table">
                <thead>
                    <tr>
                        <th class="text-uppercase small fw-bold py-3 px-4" style="color:var(--agile-text-muted);letter-spacing:0.05em" width="80">Extension</th>
                        <th class="text-uppercase small fw-bold py-3 px-4" style="color:var(--agile-text-muted);letter-spacing:0.05em">User</th>
        ...
        <div class="modal-content">
            <form action="{{ route('settings.pbx-extension-mapping.store') }}" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn" style="background:var(--agile-primary);color:#fff">Add</button>
                </div>
            </form>
        </div>
    </div>
