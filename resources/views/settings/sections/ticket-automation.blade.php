<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button type="button" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px" data-bs-toggle="modal" data-bs-target="#addRuleModal">
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0 settings-table">
                <thead>
                    <tr>
                        <th class="text-uppercase small fw-bold py-3 px-4" style="color:var(--agile-text-muted);letter-spacing:0.05em" width="100">Actions</th>
                        <th class="text-uppercase small fw-bold py-3 px-4" style="color:var(--agile-text-muted);letter-spacing:0.05em">Name</th>
                        <th class="text-uppercase small fw-bold py-3 px-4" style="color:var(--agile-text-muted);letter-spacing:0.05em">Keywords</th>
                        <th class="text-uppercase small fw-bold py-3 px-4" style="color:var(--agile-text-muted);letter-spacing:0.05em">Assign To</th>
                        <th class="text-uppercase small fw-bold py-3 px-4" style="color:var(--agile-text-muted);letter-spacing:0.05em">Priority</th>
                        <th class="text-uppercase small fw-bold py-3 px-4" style="color:var(--agile-text-muted);letter-spacing:0.05em">Active</th>
                    </tr>
                </thead>
                <tbody>
