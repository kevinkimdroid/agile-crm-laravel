...
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        <h5 class="fw-bold mb-1" style="color:var(--agile-text)">Departments</h5>
        <p class="text-muted small mb-0">Add and manage departments. Assign users to departments from the Users section.</p>
    </div>
    <button type="button" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px" data-bs-toggle="modal" data-bs-target="#addDeptModal">
        ...
        <div class="modal-content">
            <form action="{{ route('settings.departments.update', $editDepartment) }}" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn" style="background:var(--agile-primary);color:#fff;">Save</button>
                </div>
            </form>
        </div>
    </div>
