...
<div class="row g-4">
    <div class="col-md-6 col-lg-4">
        <a href="{{ route('support.serve-client') }}" class="card support-quick-card text-decoration-none h-100" style="border:2px solid var(--agile-primary);background:var(--agile-primary-muted)">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="support-quick-icon" style="background:var(--agile-primary-muted)"><i class="bi bi-person-plus-fill"></i></div>
                <div>
    ...
    <div class="col-md-6 col-lg-4">
        <a href="{{ route('marketing.broadcast') }}" class="card support-quick-card text-decoration-none h-100" style="border-color:var(--agile-primary);">
            <div class="card-body d-flex align-items-center gap-3">
    ...
    @endif
    <div class="col-md-6 col-lg-4">
        <a href="{{ route('support.maturities') }}" class="card support-quick-card text-decoration-none h-100" style="border-color:var(--agile-primary);">
            <div class="card-body d-flex align-items-center gap-3">
    ...
    <div class="col-md-6 col-lg-4">
        <a href="{{ route('support.investment-maturities') }}" class="card support-quick-card text-decoration-none h-100" style="border-color:var(--agile-primary);">
            <div class="card-body d-flex align-items-center gap-3">
    ...
    <div class="col-md-6 col-lg-4">
        <a href="{{ route('tickets.create', ['organization_id' => 'line:Group Life', 'from' => 'serve-client']) }}" class="card support-quick-card text-decoration-none h-100" style="border-color:var(--agile-primary);">
            <div class="card-body d-flex align-items-center gap-3">
