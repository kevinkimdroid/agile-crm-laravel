...
.reports-breadcrumb a { color: var(--agile-text-muted, #64748b); text-decoration: none; }
.reports-breadcrumb a:hover { color: var(--agile-primary, #1A468A); }
.reports-breadcrumb-sep { color: #cbd5e1; margin: 0 0.35rem; }
.reports-breadcrumb-current { color: var(--agile-text, #1e293b); font-weight: 500; }
.reports-audit-title { font-size: 1.5rem; font-weight: 700; color: var(--agile-text, #1e293b); }
.reports-audit-subtitle { font-size: 0.9rem; color: var(--agile-text-muted, #64748b); }
.reports-table-card {
