    ...
    <div class="col-12">
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <a href="{{ route('marketing.broadcast') }}" class="card p-4 h-100 text-decoration-none" style="border:2px solid var(--agile-primary, #0E4385);border-radius:16px;color:inherit;">
                    <div class="d-flex align-items-center gap-3">
                        <div class="rounded-3 d-flex align-items-center justify-content-center" style="width:56px;height:56px;background:var(--agile-primary-muted, rgba(14,67,133,0.12));color:var(--agile-primary, #0E4385);font-size:1.5rem;"><i class="bi bi-broadcast"></i></div>
                        <div>
