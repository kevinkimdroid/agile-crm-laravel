...
.pbx-card-title { font-size: 1.5rem; font-weight: 700; color: var(--agile-text); margin: 0 0 0.15rem; }
.pbx-card-subtitle { font-size: 0.875rem; color: var(--agile-text-muted); margin: 0; }
.pbx-card-actions {
    display: flex;
    flex-wrap: wrap;
    align-items: center;
...
.pbx-btn-primary:hover { background: var(--agile-primary-dark); }
.pbx-btn-ghost {
    background: transparent;
    color: var(--agile-text-muted);
}
.pbx-btn-ghost:hover { background: var(--agile-primary-muted); color: var(--agile-primary); }
...
.pbx-filter-tab:hover {
    ...
    background: var(--agile-primary-muted);
}
...
.pbx-filter-tab.active:hover {
    ...
    border-color: var(--agile-primary-dark);
}
.pbx-search {
    display: flex;
    align-items: center;
...
.pbx-search-input:focus { outline: none; border-color: var(--agile-primary); }
...
.pbx-number-link { display: inline-flex; margin-right: 0.35rem; color: var(--agile-primary); text-decoration: none; }
.pbx-number-link:hover { color: var(--agile-primary-dark); }
.pbx-number { font-family: ui-monospace, monospace; font-size: 0.85rem; }
.pbx-cell-muted { color: var(--agile-text-muted); font-size: 0.85rem; }
.pbx-duration { font-weight: 500; }
.pbx-time { white-space: nowrap; color: var(--agile-text-muted); font-size: 0.85rem; }
.pbx-claim-btn {
    display: inline-flex; align-items: center; padding: 0.2rem; margin-left: 0.25rem;
    background: none; border: none; color: var(--agile-text-muted); cursor: pointer; border-radius: 4px;
}
...
.pbx-inline-audio::-webkit-media-controls-panel { background: var(--agile-primary-muted); }
.pbx-play-modal-btn {
    flex-shrink: 0;
...
.pbx-empty-title { font-weight: 600; font-size: 1rem; margin: 0 0 0.4rem; color: var(--agile-text); }
.pbx-empty-text { font-size: 0.875rem; color: var(--agile-text-muted); margin: 0; }
