...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('setup.roles') }}" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px">Manage Roles</a>
    </div>
</div>
...
<div class="app-card mb-3">
    <div class="card-body d-flex flex-wrap gap-2 align-items-center justify-content-between">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center">
            ...
            <button type="submit" form="reportingBulkForm" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-role">
                            ...
                            @if ($currentRoleId)
                                <span class="badge" style="background:var(--agile-primary-muted);color:var(--agile-primary)">{{ $roleDisplay }}</span>
                            @else
                        ...
                        <td class="col-action">
                            <form action="{{ route('setup.users.update-role') }}" method="POST" class="d-inline-flex align-items-center gap-2">
                                ...
                                <button type="submit" class="btn btn-sm" style="background:var(--agile-primary);color:#fff;border-radius:8px">Save</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
...
.settings-table thead th { background: #f8fafc; border-bottom: 1px solid var(--agile-border); padding: 0.75rem 1rem; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; color: var(--agile-text-muted); }
