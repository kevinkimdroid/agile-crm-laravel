        ...
        <div class="position-relative p-4 p-sm-5">
            ...
            <div class="d-flex justify-content-between align-items-start border-bottom border-2 pb-3" style="border-color:#133A6F !important;">
                <div class="d-flex align-items-center gap-3">
                    <span class="d-inline-flex align-items-center justify-content-center rounded-3 p-2" style="background:#133A6F;">
                        <img src="{{ asset('images/agile-craft-logo.png') }}" alt="Agile Craft" style="height:34px;width:auto;filter:brightness(0) invert(1);">
                    </span>
                    <div class="small text-muted lh-sm">
                        <div>P.O Box 61316-00200 Nairobi &middot; 4th Floor, Agile Craft Insurance Plaza</div>
            ...
            <div class="d-flex justify-content-between align-items-end mt-5">
                ...
                <div class="rcpt-stamp">
                    <span class="text-uppercase fw-bold lh-1" style="font-size:.6rem;color:rgba(26,70,138,.6);text-align:center;">Agile Craft<br>Life<br>Received</span>
                </div>
            </div>
            ...
            <div class="border-top mt-3 pt-3 text-center text-muted" style="font-size:.7rem;">
                <div>Agile Craft | P.O Box 61316-00200 Nairobi | 4th Floor Agile Craft Insurance Plaza</div>
