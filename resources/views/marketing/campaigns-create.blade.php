...
<form method="POST" action="{{ route('marketing.campaigns.store') }}">
    ...
    <div class="app-card mb-4">
        <div class="p-4">
            <h6 class="text-uppercase small fw-bold mb-4" style="color:var(--agile-primary);letter-spacing:0.08em">Basic Information</h6>
            <div class="mb-4">
    ...
    <div class="app-card mb-4">
        <div class="p-4">
            <h6 class="text-uppercase small fw-bold mb-4" style="color:var(--agile-primary);letter-spacing:0.08em">Revenue & Timeline</h6>
            <div class="row g-4">
                <div class="col-md-6">
    ...
    <div class="app-card mb-4">
        <div class="p-4">
            <h6 class="text-uppercase small fw-bold mb-4" style="color:var(--agile-primary);letter-spacing:0.08em">Assignment</h6>
            <div class="row g-4">
                <div class="col-md-6">
...
<style>
.breadcrumb-nav a:hover { color: var(--agile-primary) !important; }
</style>
@endsection
