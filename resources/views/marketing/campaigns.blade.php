            ...
            <div class="campaigns-stat-card">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="campaigns-stat-value mb-0" style="color:var(--agile-success);">{{ number_format($activeCampaigns ?? 0) }}</h2>
                    </div>
            ...
            <div class="campaigns-stat-card">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="campaigns-stat-value mb-0" style="color:var(--agile-warning);">{{ number_format($planningCampaigns ?? 0) }}</h2>
                    </div>
...
.campaigns-stat-label { font-size: 0.75rem; font-weight: 600; text-transform: uppercase; color: var(--agile-text-muted); }
.campaigns-stat-icon {
...
.campaigns-stat-icon-success { background: rgba(5, 150, 105, 0.15); color: var(--agile-success); }
.campaigns-stat-icon-warning { background: rgba(217, 119, 6, 0.15); color: var(--agile-warning); }
.campaigns-stat-icon-primary { background: var(--agile-primary-muted); color: var(--agile-primary); }
...
.campaigns-pill:hover { border-color: var(--agile-primary); color: var(--agile-primary); }
.campaigns-pill.active { background: var(--agile-primary); border-color: var(--agile-primary); color: #fff; }
.campaigns-pill-count { font-size: 0.75rem; opacity: 0.85; }
.campaigns-pill-active { border-color: rgba(5, 150, 105, 0.4); }
.campaigns-pill-active.active { background: var(--agile-success); border-color: var(--agile-success); }
.campaigns-pill-planning { border-color: rgba(217, 119, 6, 0.4); }
.campaigns-pill-planning.active { background: var(--agile-warning); border-color: var(--agile-warning); }
.campaigns-pill-completed { border-color: rgba(26, 70, 138, 0.4); }
.campaigns-pill-completed.active { background: var(--agile-primary); border-color: var(--agile-primary); }
...
.campaigns-search i { color: var(--agile-text-muted); }
...
.campaigns-table th { font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; color: var(--agile-text-muted); padding: 1rem 1.25rem; white-space: nowrap; }
.campaigns-table td { padding: 1rem 1.25rem; vertical-align: middle; }
.campaigns-table tbody tr:hover { background: var(--agile-primary-muted); }
.campaigns-name-link { font-weight: 500; color: var(--agile-text); text-decoration: none; }
.campaigns-name-link:hover { color: var(--agile-primary); }
.campaigns-row-icon {
...
.campaigns-status-active { background: rgba(5, 150, 105, 0.15); color: var(--agile-success); }
.campaigns-status-planning { background: rgba(217, 119, 6, 0.15); color: var(--agile-warning); }
.campaigns-status-completed { background: var(--agile-primary-muted); color: var(--agile-primary); }
.campaigns-status- { background: rgba(100, 116, 139, 0.15); color: var(--agile-text-muted); }
.campaigns-revenue { color: var(--agile-primary); font-size: 0.9rem; }
...
.campaigns-pagination .page-link { border-radius: 8px; border-color: var(--agile-border); color: var(--agile-text); }
.campaigns-pagination .page-link:hover { background: var(--agile-primary-muted); border-color: var(--agile-primary); color: var(--agile-primary); }
.campaigns-pagination .page-item.active .page-link { background: var(--agile-primary); border-color: var(--agile-primary); }
</style>
@endsection
