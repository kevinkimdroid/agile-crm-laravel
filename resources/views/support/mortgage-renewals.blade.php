                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-5">
                            ...
                            @else
                                <div class="rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width:4rem;height:4rem;background:var(--agile-primary-muted);color:var(--agile-primary)">
