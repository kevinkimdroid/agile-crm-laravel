...
.serve-client-input:focus {
    ...
    box-shadow: 0 0 0 3px var(--agile-primary-muted);
}
...
.serve-client-item-name { font-weight: 600; font-size: 1.05rem; color: var(--agile-text); margin-bottom: 0.35rem; }
.serve-client-item-meta { font-size: 0.8rem; color: var(--agile-text-muted); margin-bottom: 0.5rem; }
...
.serve-client-detail-label { color: var(--agile-text-muted); }
.serve-client-detail-value { font-weight: 600; color: var(--agile-text); }
...
.serve-client-actions {
    ...
    padding-top: 1rem; border-top: 1px solid var(--agile-border);
...
.serve-client-cta:hover { background: var(--agile-primary-dark); color: #fff !important; }
...
.serve-client-empty-detail { color: var(--agile-text-muted); }
