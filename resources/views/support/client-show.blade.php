...
<div class="row g-4">
    <div class="col-lg-8">
        <div class="app-card p-4">
            <h6 class="text-uppercase small fw-bold mb-3" style="color:var(--agile-primary);letter-spacing:0.08em">Client Details</h6>
            <div class="row g-3">
                <div class="col-md-6">
        ...
        <div class="app-card p-4 mt-4">
            <h6 class="text-uppercase small fw-bold mb-3" style="color:var(--agile-primary);letter-spacing:0.08em">Related Tickets</h6>
    ...
    <div class="col-lg-4">
        <div class="app-card p-4">
            <h6 class="text-uppercase small fw-bold mb-3" style="color:var(--agile-primary);letter-spacing:0.08em">Quick Actions</h6>
...
<style>
.client-detail-dl dt { font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--agile-text-muted); margin-top: 0.75rem; margin-bottom: 0.2rem; }
