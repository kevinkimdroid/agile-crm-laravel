        ...
        <div class="p-4">
            ...
            <div class="row g-4 mt-2">
                <div class="col-md-6">
                    ...
                    <input type="text" name="complainant_name" class="form-control" value="{{ old('complainant_name') }}" required>
                    @error('complainant_name')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Phone</label>
                    <input type="text" name="complainant_phone" class="form-control" value="{{ old('complainant_phone') }}" placeholder="e.g. 0712345678">
                </div>
            </div>
            <div class="row g-4 mt-2">
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Email</label>
                    <input type="email" name="complainant_email" class="form-control" value="{{ old('complainant_email') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="policy_number" class="form-control font-monospace" value="{{ old('policy_number') }}" placeholder="e.g. GEMPPP0334">
                </div>
            </div>
            <div class="mt-4">
    ...
    <div class="app-card mb-4">
        <div class="p-4">
            ...
            <div class="mt-4">
                ...
                <input type="text" name="assigned_to" class="form-control" value="{{ old('assigned_to') }}" placeholder="Staff member handling this complaint">
            </div>
        </div>
    </div>
