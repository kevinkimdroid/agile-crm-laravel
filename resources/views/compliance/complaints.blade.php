            ...
            <div class="complaints-stat-card">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="complaints-stat-value mb-0" style="color:var(--agile-warning);">{{ number_format($received ?? 0) }}</h2>
                    </div>
            ...
            <div class="complaints-stat-card">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="complaints-stat-value mb-0" style="color:var(--agile-success);">{{ number_format($resolved ?? 0) }}</h2>
                    </div>
            ...
            <div class="complaints-stat-card">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="complaints-stat-value mb-0" style="color:var(--agile-text-muted);">{{ number_format($closed ?? 0) }}</h2>
                    </div>
...
<style>
.complaints-stat-card { background:#fff; border-radius:12px; border:1px solid var(--agile-border); padding:1.25rem 1.5rem; transition:all .2s; }
.complaints-stat-card:hover { box-shadow:0 4px 12px rgba(0,0,0,.06); }
.complaints-stat-primary { background:linear-gradient(135deg, var(--agile-primary), var(--agile-primary-dark)); border:none; color:#fff; }
...
.complaints-stat-icon-warning { background:rgba(217,119,6,.15); color:var(--agile-warning); }
.complaints-stat-icon-success { background:rgba(5,150,105,.15); color:var(--agile-success); }
.complaints-stat-icon-muted { background:rgba(100,116,139,.15); color:var(--agile-text-muted); }

.complaints-status-pills { display:flex; flex-wrap:wrap; gap:.5rem; }
.complaints-pill { display:inline-flex; align-items:center; gap:.4rem; padding:.5rem 1rem; border-radius:9999px; background:#fff; border:1px solid var(--agile-border); color:var(--agile-text); text-decoration:none; font-size:.875rem; font-weight:500; transition:all .2s; }
.complaints-pill:hover { border-color:var(--agile-primary); color:var(--agile-primary); }
.complaints-pill.active { background:var(--agile-primary); border-color:var(--agile-primary); color:#fff; }
.complaints-pill-count { font-size:.75rem; opacity:.85; }

.complaints-toolbar { display:flex; flex-wrap:wrap; align-items:center; gap:.75rem; padding:1rem 1.25rem; background:#f8fafc; border-bottom:1px solid var(--agile-border); }
.complaints-search { flex:1; min-width:200px; max-width:360px; display:flex; align-items:center; gap:.5rem; padding:.5rem 1rem; background:#fff; border:1px solid var(--agile-border); border-radius:8px; }
.complaints-search input { padding:0; font-size:.9rem; }
.complaints-select { max-width:180px; border-radius:8px; }

.complaints-table th { font-size:.7rem; font-weight:700; text-transform:uppercase; letter-spacing:.06em; color:var(--agile-text-muted); padding:1rem 1.25rem; }
.complaints-table td { padding:1rem 1.25rem; vertical-align:middle; }
.complaints-table tbody tr:hover { background:var(--agile-primary-muted); }
.complaints-ref-link { color:var(--agile-primary); text-decoration:none; }
...
.complaints-status-received { background:rgba(217,119,6,.15); color:var(--agile-warning); }
.complaints-status-under-investigation { background:rgba(14,165,233,.15); color:#0284c7; }
.complaints-status-pending-response { background:rgba(217,119,6,.15); color:var(--agile-warning); }
.complaints-status-resolved { background:rgba(5,150,105,.15); color:var(--agile-success); }
.complaints-status-escalated-to-ira { background:rgba(220,38,38,.15); color:#dc2626; }
.complaints-status-closed { background:rgba(100,116,139,.15); color:var(--agile-text-muted); }

.complaints-empty-icon { width:72px; height:72px; margin:0 auto; background:var(--agile-primary-muted); color:var(--agile-primary); border-radius:16px; display:flex; align-items:center; justify-content:center; font-size:2rem; }
.complaints-pagination { display:flex; flex-wrap:wrap; justify-content:space-between; align-items:center; gap:1rem; padding:1rem 1.25rem; background:#f8fafc; border-top:1px solid var(--agile-border); }
</style>
@endsection
