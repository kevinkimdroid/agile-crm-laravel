...
<form method="POST" action="{{ route('tickets.update', $ticket->ticketid) }}">
    ...
    <div class="app-card mb-4">
        <div class="p-4">
            <h6 class="text-uppercase small fw-bold mb-4" style="color:var(--agile-primary);letter-spacing:0.08em">Ticket Information</h6>
            <div class="row g-4">
                <div class="col-md-6">
                ...
                <div class="col-md-6 position-relative" id="contactSearchWrapper">
                    ...
                    <div id="contactDropdown" class="contact-dropdown position-absolute w-100 mt-1 shadow border rounded-3 overflow-hidden" style="display: none; z-index: 1050; max-height: 320px; overflow-y: auto; background: #fff; border: 1px solid var(--agile-border, #e2e8f0) !important;" role="listbox"></div>
...
(function() {
    ...
    function renderDropdown(items, isLoading, noResults) {
        ...
        if (isLoading) {
            ...
            dropdown.innerHTML = '<div class="list-group-item text-muted py-3 text-center">No prospects found. Try a different search or <a href="{{ route("contacts.create") }}">add a new prospect</a>.</div>';
            dropdown.style.display = 'block';
