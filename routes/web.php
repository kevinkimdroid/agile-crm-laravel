...
Route::get('/support/faq/search', [\App\Http\Controllers\FaqController::class, 'search'])->name('support.faq.search');
Route::post('/support/faq/helpful', [\App\Http\Controllers\FaqController::class, 'markHelpful'])->name('support.faq.helpful');
Route::get('/support/faq/manage', [\App\Http\Controllers\FaqController::class, 'manage'])->name('support.faq.manage');
Route::post('/support/faq/categories', [\App\Http\Controllers\FaqController::class, 'storeCategory'])->name('support.faq.categories.store');
Route::put('/support/faq/categories/{category}', [\App\Http\Controllers\FaqController::class, 'updateCategory'])->name('support.faq.categories.update');
Route::delete('/support/faq/categories/{category}', [\App\Http\Controllers\FaqController::class, 'destroyCategory'])->name('support.faq.categories.destroy');
Route::get('/support/faq/articles/create', [\App\Http\Controllers\FaqController::class, 'createArticle'])->name('support.faq.articles.create');
Route::post('/support/faq/articles', [\App\Http\Controllers\FaqController::class, 'storeArticle'])->name('support.faq.articles.store');
Route::get('/support/faq/articles/{article}/edit', [\App\Http\Controllers\FaqController::class, 'editArticle'])->name('support.faq.articles.edit');
Route::put('/support/faq/articles/{article}', [\App\Http\Controllers\FaqController::class, 'updateArticle'])->name('support.faq.articles.update');
Route::delete('/support/faq/articles/{article}', [\App\Http\Controllers\FaqController::class, 'destroyArticle'])->name('support.faq.articles.destroy');
...
Route::get('/demo/restricted-client-access', [\App\Http\Controllers\RestrictedClientAccessDemoController::class, 'index'])->name('demo.restricted-access');
Route::post('/demo/restricted-client-access/seed', [\App\Http\Controllers\RestrictedClientAccessDemoController::class, 'seed'])->name('demo.restricted-access.seed');
Route::post('/demo/restricted-client-access/start', [\App\Http\Controllers\RestrictedClientAccessDemoController::class, 'start'])->name('demo.restricted-access.start');
Route::post('/demo/restricted-client-access/stop', [\App\Http\Controllers\RestrictedClientAccessDemoController::class, 'stop'])->name('demo.restricted-access.stop');
Route::get('/demo/restricted-client-access/attempt', [\App\Http\Controllers\RestrictedClientAccessDemoController::class, 'attempt'])->name('demo.restricted-access.attempt');
Route::prefix('compliance')->name('compliance.')->group(function () {
    Route::get('complaints/export', [\App\Http\Controllers\ComplaintController::class, 'export'])->name('complaints.export');
    Route::get('complaints/lookup/clients', [\App\Http\Controllers\ComplaintController::class, 'lookupClients'])->name('complaints.lookup.clients');
    Route::get('complaints/lookup/prospects', [\App\Http\Controllers\ComplaintController::class, 'lookupProspects'])->name('complaints.lookup.prospects');
...
Route::get('/support/clients/create', [\App\Http\Controllers\CustomerController::class, 'create'])->name('support.clients.create');
Route::post('/support/clients', [\App\Http\Controllers\CustomerController::class, 'store'])->name('support.clients.store');
Route::get('/support/clients/import', [\App\Http\Controllers\CustomerController::class, 'importForm'])->name('support.clients.import');
Route::post('/support/clients/import', [\App\Http\Controllers\CustomerController::class, 'import'])->name('support.clients.import.store');
Route::get('/support/clients/import/template', [\App\Http\Controllers\CustomerController::class, 'importTemplate'])->name('support.clients.import.template');
...
Route::post('/settings/crm/ticket-sla/sync-departments', [\App\Http\Controllers\TicketSlaController::class, 'syncFromDepartments'])->name('settings.ticket-sla.sync-departments');
...
Route::post('/settings/crm/ticket-sla/categories', [\App\Http\Controllers\TicketSlaController::class, 'addCategoryTat'])->name('settings.ticket-sla.add-category');
Route::post('/settings/crm/ticket-sla/categories/update', [\App\Http\Controllers\TicketSlaController::class, 'updateCategoryTat'])->name('settings.ticket-sla.update-category');
...
Route::get('/reports/sla-broken-work', [\App\Http\Controllers\ReportsController::class, 'slaBrokenWork'])->name('reports.sla-broken-work');
...
Route::get('/reports/export/sla-broken-work', [\App\Http\Controllers\ReportsController::class, 'exportSlaBrokenWork'])->name('reports.export.sla-broken-work');
