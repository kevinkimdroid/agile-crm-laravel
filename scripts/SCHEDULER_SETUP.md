...
2. **Create Task** (not Basic Task):
   - **General**: Name = `Agile Craft Laravel Scheduler`, Run whether user is logged on or not
...
- Program: `C:\xampp\htdocs\sites\agile-crm-laravel\scripts\run-scheduler.bat`
- Start in: `C:\xampp\htdocs\sites\agile-crm-laravel`
