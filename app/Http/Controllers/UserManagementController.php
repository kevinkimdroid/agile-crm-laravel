...
class UserManagementController extends Controller
{
    ...
    {
        foreach (['agile_ticket_counts_by_status', 'agile_tickets_count', 'tickets_list_default', 'agile_contacts_count', 'agile_leads_count', 'agile_deals_count', 'agile_dashboard_stats'] as $key) {
            Cache::forget($key);
        }
