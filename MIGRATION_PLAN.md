# Agile Craft CRM → Laravel 11 Migration Plan

## Overview
This document outlines the phased migration of Agile Craft CRM (Vtiger-based) to Laravel 11 while **preserving all existing features**.
