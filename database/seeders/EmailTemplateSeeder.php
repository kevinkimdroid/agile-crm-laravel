    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                ...
                'body' => 'Hi {{firstname}}, Agile Craft: [one-line offer]. Questions? 0709551150.',
            ],
        ];
