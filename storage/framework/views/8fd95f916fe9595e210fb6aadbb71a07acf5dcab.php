...
<head>
    ...
    <title>Sign In — <?php echo e(config('branding.client_short')); ?></title>
    ...
    <link rel="preload" href="<?php echo e(asset('images/login-hero.jpg')); ?>?v=4" as="image">
    <?php echo $__env->make('partials.client-brand-styles', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <style>
        :root {
            --brand-navy: <?php echo e(config('branding.primary')); ?>;
            --brand-navy-dark: <?php echo e(config('branding.primary_dark')); ?>;
            --brand-red: <?php echo e(config('branding.accent')); ?>;
            --brand-logo-bg: <?php echo e(config('branding.logo_bg')); ?>;
            --brand-gray: #64748b;
        }
...
<body>
    <div class="login-page">
        <div class="login-bg-img">
            <img src="<?php echo e(asset('images/login-hero.jpg')); ?>?v=4" alt="" width="1920" height="1080" loading="eager" fetchpriority="high">
        </div>
        <div class="login-left">
            <div class="login-left-inner">
                <div class="login-card">
                    <div class="login-brand">
                        <?php echo $__env->make('partials.client-brand', ['variant' => 'full'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <?php if($errors->any()): ?>
                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="user_name" id="user_name" class="login-input" value="<?php echo e(old('user_name')); ?>" placeholder="Enter your username" required autofocus>
                            </div>
                            <div class="mb-2">
                ...
                <div class="login-social">
                    <?php if(config('branding.social.facebook')): ?>
                    <a href="<?php echo e(config('branding.social.facebook')); ?>" target="_blank" rel="noopener" aria-label="Facebook"><i class="bi bi-facebook"></i></a>
                    <?php endif; ?>
                    <?php if(config('branding.social.instagram')): ?>
                    <a href="<?php echo e(config('branding.social.instagram')); ?>" target="_blank" rel="noopener" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                    <?php endif; ?>
                    <?php if(config('branding.social.twitter')): ?>
                    <a href="<?php echo e(config('branding.social.twitter')); ?>" target="_blank" rel="noopener" aria-label="Twitter"><i class="bi bi-twitter-x"></i></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="login-tagline">
            ...
            <span><?php echo e(config('branding.tagline')); ?></span>
        </div>

        <footer class="login-footer">
            <?php echo e(config('branding.platform_footer')); ?> © <?php echo e(date('Y')); ?> · <a href="#">Privacy Policy</a>
        </footer>
    </div>
...
<?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>