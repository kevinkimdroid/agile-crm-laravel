...
<head>
    ...
    <title>Session Expired — Agile Craft</title>
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/agile-craft-logo.png')); ?>">
...
<body>
    <div class="err-card">
        ...
        <div class="err-actions">
            <a href="<?php echo e(request()->header('referer') ?? url('/')); ?>" class="err-btn err-btn-primary">
                <i class="bi bi-arrow-clockwise"></i> Refresh & try again
            </a>
            <a href="<?php echo e(url('/')); ?>" class="err-btn err-btn-secondary">
...
<?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/errors/419.blade.php ENDPATH**/ ?>