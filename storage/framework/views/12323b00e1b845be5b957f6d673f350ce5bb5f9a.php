<?php $__env->startSection('title', config('branding.client_short') . ' Dashboard'); ?>

<?php $__env->startSection('content'); ?>
<?php if(session('error')): ?>
    <div class="alert alert-danger alert-dismissible fade show mx-3 mx-md-4 mt-3" role="alert">
        <i class="bi bi-exclamation-octagon-fill me-2"></i><?php echo e(session('error')); ?>
...
<div class="dashboard">
    ...
    <header class="dashboard-welcome">
        <div class="dashboard-welcome-body">
            <div class="dashboard-welcome-text">
                <p class="dashboard-welcome-date"><?php echo e(now()->format('l, F j')); ?></p>
                <h1 class="dashboard-welcome-heading">
                    <?php echo e($greeting); ?><?php echo e($firstName ? ',' : ''); ?>

                    <span class="dashboard-welcome-name"><?php echo e($firstName ?? 'Welcome back'); ?></span>
                </h1>
                <p class="dashboard-welcome-meta"><?php echo e(config('branding.client_short')); ?> <?php echo e(config('branding.app_name')); ?> <span class="dashboard-welcome-dot" aria-hidden="true">·</span> <em><?php echo e(config('branding.tagline')); ?></em></p>
            </div>
            <div class="dashboard-welcome-toolbar">
                <?php if((isset($clientsCount) && $clientsCount !== null) || ($clientsCountDeferred ?? false)): ?>
                <a href="<?php echo e(route('support.customers')); ?>" class="dashboard-welcome-btn dashboard-welcome-btn-outline">
                    <i class="bi bi-people-fill"></i><span>Clients</span>
                </a>
                <?php endif; ?>
                <a href="<?php echo e(route('tickets.create')); ?>" class="dashboard-welcome-btn dashboard-welcome-btn-primary">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <?php if(Route::has('support.maturities')): ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('support.maturities')); ?>"><i class="bi bi-calendar2-event me-2"></i>Maturities</a></li>
                        <?php endif; ?>
                        <li><a class="dropdown-item" href="<?php echo e(route('tickets.index')); ?>"><i class="bi bi-ticket-perforated me-2"></i>Tickets</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('reports')); ?>"><i class="bi bi-bar-chart-line me-2"></i>Reports</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('activities.index', ['overdue' => 1])); ?>"><i class="bi bi-exclamation-triangle me-2"></i>Overdue</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('reports')); ?>"><i class="bi bi-download me-2"></i>Export</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="dashboard-kpis<?php echo e((($clientsCountDeferred ?? false) || (isset($clientsCount) && $clientsCount !== null)) ? '' : ' dashboard-kpis-4'); ?>">
        <a href="<?php echo e(route('deals.index')); ?>" class="dashboard-kpi dashboard-kpi-featured">
            ...
            <div class="dashboard-kpi-content">
                ...
                <span class="dashboard-kpi-value">KES <?php echo e(number_format($pipelineValue ?? 0, 0)); ?></span>
                <span class="dashboard-kpi-meta"><?php echo e(number_format($dealsCount ?? 0)); ?> active deals</span>
            </div>
        </a>
        <a href="<?php echo e(route('contacts.index')); ?>" class="dashboard-kpi">
            <span class="dashboard-kpi-value" id="contactsCountValue"><?php echo e($contactsCountDeferred ?? false ? '—' : number_format($contactsCount ?? 0)); ?></span>
            <span class="dashboard-kpi-label">Prospects</span>
        </a>
        <a href="<?php echo e(route('leads.index')); ?>" class="dashboard-kpi">
            <span class="dashboard-kpi-value"><?php echo e(number_format($leadsCount ?? 0)); ?></span>
            <span class="dashboard-kpi-label">Leads</span>
            <?php if(($leadsTodayCount ?? 0) > 0): ?>
            <span class="dashboard-kpi-badge"><?php echo e($leadsTodayCount); ?> new</span>
            <?php endif; ?>
        </a>
        <?php if(($clientsCountDeferred ?? false) || (isset($clientsCount) && $clientsCount !== null)): ?>
        <div class="dashboard-kpi dashboard-kpi-static" id="clientsStatCard">
            <span class="dashboard-kpi-value" id="clientsCountValue" data-local-count="<?php echo e((int) ($clientsCount ?? 0)); ?>"><?php echo e(number_format($clientsCount ?? 0)); ?></span>
            <span class="dashboard-kpi-label">Clients</span>
            <a href="<?php echo e(route('support.customers')); ?>" class="dashboard-kpi-link">View</a>
        </div>
        <?php endif; ?>
        <a href="<?php echo e(route('deals.index')); ?>" class="dashboard-kpi">
            <span class="dashboard-kpi-value"><?php echo e(number_format($dealsCount ?? 0)); ?></span>
    ...
    <section class="dashboard-actions dashboard-actions-top">
        ...
        <div class="dashboard-actions-btns">
            <?php if((isset($clientsCount) && $clientsCount !== null) || ($clientsCountDeferred ?? false)): ?>
            <a href="<?php echo e(route('support.customers')); ?>" class="dashboard-action-btn"><i class="bi bi-people"></i> Clients</a>
            <?php if(in_array(config('erp.clients_view_source', 'crm'), ['erp_http', 'erp_sync'])): ?>
            <a href="<?php echo e(route('support.customers', ['system' => 'group'])); ?>" class="dashboard-action-btn"><i class="bi bi-people-fill"></i> Group Life</a>
            <a href="<?php echo e(route('support.customers', ['system' => 'individual'])); ?>" class="dashboard-action-btn"><i class="bi bi-person-fill"></i> Individual</a>
            <?php endif; ?>
            <?php endif; ?>
            <?php if($pbxCanCall ?? false): ?>
            <a href="<?php echo e(route('tools.pbx-manager')); ?>" class="dashboard-action-btn"><i class="bi bi-telephone"></i> Call</a>
            <?php endif; ?>
            <?php if(($can ?? null) && $can('work-tickets')): ?>
            <a href="<?php echo e(route('work-tickets.index')); ?>" class="dashboard-action-btn dashboard-action-btn-primary"><i class="bi bi-kanban"></i> Work Tickets</a>
            <?php endif; ?>
            <a href="<?php echo e(route('tickets.create')); ?>" class="dashboard-action-btn"><i class="bi bi-ticket-perforated"></i> New Ticket</a>
            <a href="<?php echo e(route('leads.create')); ?>" class="dashboard-action-btn"><i class="bi bi-plus-circle"></i> Add Lead</a>
            <a href="<?php echo e(route('contacts.index')); ?>" class="dashboard-action-btn"><i class="bi bi-person"></i> Prospects</a>
            <a href="<?php echo e(route('deals.index')); ?>" class="dashboard-action-btn"><i class="bi bi-briefcase"></i> Deals</a>
        </div>
    </section>
                ...
                <div class="dashboard-card-head">
                    ...
                    <div class="dashboard-card-actions">
                        <div class="dropdown">
                            ...
                            ?>
                            <button class="btn btn-sm btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown"><?php echo e($overdueScopeLabel); ?></button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item <?php echo e(($overdueScope ?? 'mine') === 'mine' ? 'active' : ''); ?>"
                                       href="<?php echo e(route('dashboard', ['overdue_scope' => 'mine'])); ?>">Mine</a>
                                </li>
                                <?php if($canViewAllOverdue ?? false): ?>
                                <li>
                                    <a class="dropdown-item <?php echo e(($overdueScope ?? 'mine') === 'all' ? 'active' : ''); ?>"
                                       href="<?php echo e(route('dashboard', ['overdue_scope' => 'all'])); ?>">Everyone</a>
                                </li>
                                <?php endif; ?>
                            </ul>
                        </div>
                        <a href="<?php echo e(route('activities.index', ['overdue' => 1, 'scope' => $overdueScope ?? 'mine'])); ?>" class="dashboard-card-link">View</a>
                    </div>
                </div>
                <div class="dashboard-list dashboard-list-overdue">
                    <?php $__empty_1 = true; $__currentLoopData = ($overdueActivities ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <a href="<?php echo e($activityUrl); ?>" class="dashboard-list-row dashboard-list-row-overdue text-decoration-none text-body">
                            <i class="bi bi-exclamation-circle"></i>
                            <div>
                                <span><?php echo e($activity['subject']); ?></span>
                                <small><?php echo e(!empty($activity['due_date']) ? \Carbon\Carbon::parse($activity['due_date'])->diffForHumans() : '—'); ?></small>
                            </div>
                        </a>
        ...
        <div class="dashboard-section-grid dashboard-section-grid-2">
            <div class="dashboard-card">
                <div class="dashboard-card-head">
                    ...
                    <a href="<?php echo e(route('tickets.index')); ?>" class="dashboard-card-link">View all</a>
                </div>
                <div class="dashboard-ticket-grid">
                    <a href="<?php echo e(route('tickets.index', ['list' => 'Open'])); ?>" class="dashboard-ticket-item">
                        <span class="dashboard-ticket-num"><?php echo e($open); ?></span>
                        <span class="dashboard-ticket-lbl">Open</span>
                        <div class="dashboard-ticket-bar"><div class="dashboard-ticket-fill" style="width:<?php echo e(($open/$max)*100); ?>%"></div></div>
                    </a>
                    <a href="<?php echo e(route('tickets.index', ['list' => 'In Progress'])); ?>" class="dashboard-ticket-item">
                        <span class="dashboard-ticket-num"><?php echo e($inProgress); ?></span>
                        <span class="dashboard-ticket-lbl">In Progress</span>
                        <div class="dashboard-ticket-bar"><div class="dashboard-ticket-fill" style="width:<?php echo e(($inProgress/$max)*100); ?>%"></div></div>
                    </a>
                    <a href="<?php echo e(route('tickets.index', ['list' => 'Wait For Response'])); ?>" class="dashboard-ticket-item">
                        <span class="dashboard-ticket-num"><?php echo e($waitResp); ?></span>
                        <span class="dashboard-ticket-lbl">Waiting</span>
                        <div class="dashboard-ticket-bar"><div class="dashboard-ticket-fill" style="width:<?php echo e(($waitResp/$max)*100); ?>%"></div></div>
                    </a>
                    <a href="<?php echo e(route('tickets.index', ['list' => 'Closed'])); ?>" class="dashboard-ticket-item">
                        <span class="dashboard-ticket-num"><?php echo e($closed); ?></span>
                        <span class="dashboard-ticket-lbl">Closed</span>
                        <div class="dashboard-ticket-bar"><div class="dashboard-ticket-fill" style="width:<?php echo e(($closed/$max)*100); ?>%"></div></div>
                    </a>
                </div>
            </div>
                ...
                <div class="dashboard-donut">
                    <div class="dashboard-donut-chart">
                        <svg viewBox="0 0 36 36">
                            ...
                            <path class="dashboard-donut-resolved" stroke-dasharray="<?php echo e($ticketResolvedPct); ?>, 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"/>
                            <path class="dashboard-donut-pending" stroke-dasharray="<?php echo e(100 - $ticketResolvedPct); ?>, 100" stroke-dashoffset="<?php echo e(-$ticketResolvedPct); ?>" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"/>
                        </svg>
                        <div class="dashboard-donut-center"><?php echo e($ticketResolvedPct); ?>%</div>
                    </div>
                    <div class="dashboard-donut-legend">
                        <span><i style="background:var(--dash-success)"></i> Closed <?php echo e($ticketClosed); ?></span>
                        <span><i style="background:var(--dash-accent)"></i> Open <?php echo e($ticketOpen); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="dashboard-section-grid dashboard-section-grid-3">
            <div class="dashboard-card">
                <div class="dashboard-card-head">
                    ...
                    <a href="<?php echo e(route('reports')); ?>" class="dashboard-card-link">View</a>
                </div>
                <?php $salesByPerson = $salesByPerson ?? collect(); ?>
                <?php if($salesByPerson->isNotEmpty()): ?>
                    <div class="dashboard-list">
                        <?php $__currentLoopData = $salesByPerson->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="dashboard-list-row">
                                <span><?php echo e($row->name); ?></span>
                                <span class="dashboard-list-amount">KES <?php echo e(number_format($row->total ?? 0, 0)); ?></span>
                            </div>
                ...
                <?php else: ?>
                    <div class="dashboard-empty">
                        ...
                        <a href="<?php echo e(route('deals.index')); ?>" class="btn btn-sm btn-primary mt-2">View Deals</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="dashboard-card">
                <div class="dashboard-card-head">
                    ...
                    <a href="<?php echo e(route('leads.index')); ?>" class="dashboard-card-link">View</a>
                </div>
                <?php $leadsBySource = $leadsBySource ?? []; $totalLeads = array_sum($leadsBySource); ?>
                <?php if(count($leadsBySource) > 0): ?>
                    <div class="dashboard-bars">
                        <?php $__currentLoopData = $leadsBySource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source => $cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="dashboard-bar">
                                <span class="dashboard-bar-label"><?php echo e($source); ?></span>
                                <div class="dashboard-bar-track"><div class="dashboard-bar-fill" style="width:<?php echo e($totalLeads > 0 ? ($cnt/$totalLeads)*100 : 0); ?>%"></div></div>
                                <span class="dashboard-bar-count"><?php echo e($cnt); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
            ...
            <div class="dashboard-card">
                <div class="dashboard-card-head">
                    ...
                    <a href="<?php echo e(route('deals.index')); ?>" class="dashboard-card-link">View</a>
                </div>
                <?php $dealsClosingSoon = $dealsClosingSoon ?? collect(); ?>
                <?php if($dealsClosingSoon->isNotEmpty()): ?>
                    <div class="dashboard-list">
                        <?php $__currentLoopData = $dealsClosingSoon->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('deals.show', $deal->potentialid)); ?>" class="dashboard-list-row dashboard-list-row-link">
                                <div>
                                    <strong><?php echo e($deal->potentialname); ?></strong>
                                    <small><?php echo e($deal->closingdate ? \Carbon\Carbon::parse($deal->closingdate)->format('M j, Y') : '—'); ?></small>
                                </div>
                                <span class="dashboard-list-badge">KES <?php echo e(number_format($deal->amount ?? 0, 0)); ?></span>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
                    <div class="dashboard-empty"><i class="bi bi-calendar-x"></i><span>No deals in 30 days</span><a href="<?php echo e(route('deals.index')); ?>" class="btn btn-sm btn-primary mt-2">View Deals</a></div>
                <?php endif; ?>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('partials.dashboard-staff-banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<style>
:root {
    --dash-bg: #f4f7fb;
    --dash-card: #ffffff;
    --dash-primary: <?php echo e(config('branding.primary')); ?>;
    --dash-primary-dark: <?php echo e(config('branding.primary_dark')); ?>;
    --dash-primary-light: #3d6eb5;
    --dash-accent: <?php echo e(config('branding.accent')); ?>;
    --dash-primary-soft: color-mix(in srgb, <?php echo e(config('branding.primary')); ?> 9%, white);
    --dash-accent-soft: color-mix(in srgb, <?php echo e(config('branding.accent')); ?> 10%, white);
    --dash-text: #1e293b;
    --dash-text-soft: #64748b;
    --dash-border: color-mix(in srgb, <?php echo e(config('branding.primary')); ?> 11%, white);
    --dash-success: #0d9488;
    --dash-danger: #dc2626;
    --dash-radius: 12px;
    --dash-radius-lg: 14px;
    --dash-shadow: 0 1px 3px color-mix(in srgb, <?php echo e(config('branding.primary')); ?> 8%, transparent);
    --dash-shadow-hover: 0 8px 24px color-mix(in srgb, <?php echo e(config('branding.primary')); ?> 14%, transparent);
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if($clientsCountDeferred ?? false): ?>
    if (clientsEl) {
        fetch('<?php echo e(route("api.dashboard.clients-count")); ?>', { headers: { 'Accept': 'application/json' }, credentials: 'same-origin' })
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/dashboard.blade.php ENDPATH**/ ?>