...
<div class="row g-4">
    ...
    <div class="col-md-6 col-lg-4">
        <a href="<?php echo e(route('tools.erp-messaging')); ?>" class="text-decoration-none text-dark">
        <div class="card tools-card h-100">
            <div class="card-body p-4 d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('tools.erp-messaging.sent')); ?>" class="small">View sent history & times</a>
                </div>
            </div>
        </div>
        </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/tools.blade.php ENDPATH**/ ?>