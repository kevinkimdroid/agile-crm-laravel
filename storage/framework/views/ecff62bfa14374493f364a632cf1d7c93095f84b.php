        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="pbxCallExtension" class="form-control" placeholder="e.g. 2002 (for Dial PBX only)" value="<?php echo e($pbxDefaultExtension ?? ''); ?>">
                </div>
...
(function() {
    ...
    submitBtn?.addEventListener('click', async function() {
        ...
        hideMessage();
        try {
            const res = await fetch('<?php echo e(route("tools.pbx-manager.make-call")); ?>', {
                method: 'POST',
                headers: {
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/partials/pbx-tel-handler.blade.php ENDPATH**/ ?>