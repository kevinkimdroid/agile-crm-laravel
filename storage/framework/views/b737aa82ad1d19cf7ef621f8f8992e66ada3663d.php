...
$sections = [
    ...
    'Tickets' => [
        ...
        ['section' => 'ticket-sla', 'icon' => 'bi-stopwatch', 'name' => 'SLA & TAT', 'hint' => 'Category & department turnaround, close rules', 'keywords' => 'sla tat turnaround category department close'],
...
<div class="settings-overview">
    <div class="settings-overview-hero mb-4">
        <div class="d-flex flex-wrap align-items-start justify-content-between gap-3">
            ...
            <a href="<?php echo e(route('settings.crm')); ?>?section=users" class="btn btn-light btn-sm settings-overview-hero-btn">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
            <div class="settings-overview-stat">
                ...
                <span class="settings-overview-stat-value"><?php echo e(number_format($stats['users'] ?? 0)); ?></span>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="settings-overview-stat">
                <span class="settings-overview-stat-label">Roles</span>
                <span class="settings-overview-stat-value"><?php echo e(number_format($stats['roles'] ?? 0)); ?></span>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="settings-overview-stat">
                <span class="settings-overview-stat-label">Departments</span>
                <span class="settings-overview-stat-value"><?php echo e(number_format($stats['departments'] ?? 0)); ?></span>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="settings-overview-stat">
                <span class="settings-overview-stat-label">Modules enabled</span>
                <span class="settings-overview-stat-value"><?php echo e(number_format($stats['modules'] ?? 0)); ?></span>
            </div>
        </div>
    </div>
    ...
    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $cards): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <section class="settings-overview-group mb-4" data-settings-group>
        <h3 class="settings-overview-group-title"><?php echo e($groupName); ?></h3>
        <div class="settings-overview-grid">
            ...
            <a href="<?php echo e($href); ?>"
               ...
               data-search="<?php echo e($searchText); ?>">
                <span class="settings-overview-icon"><i class="bi <?php echo e($card['icon']); ?>"></i></span>
                <span class="settings-overview-name"><?php echo e($card['name']); ?></span>
                <span class="settings-overview-hint"><?php echo e($card['hint']); ?></span>
...
<?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/settings/sections/overview.blade.php ENDPATH**/ ?>