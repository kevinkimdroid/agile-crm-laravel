<?php $__env->startSection('title', 'Renewals'); ?>
...
<div class="mat-hero">
    <div class="d-flex flex-wrap align-items-start justify-content-between gap-3 position-relative" style="z-index:1">
        <div class="d-flex align-items-start gap-3">
            <div class="mat-hero-icon" aria-hidden="true"><i class="bi <?php echo e($productIcon); ?>"></i></div>
            <div>
                <h1 class="h3 fw-bold mb-1">Renewals</h1>
                <p class="mb-2 opacity-90 small" style="max-width:36rem">
                    <strong><?php echo e($productLabel); ?></strong> policies due for renewal in the next <strong><?php echo e($window); ?> days</strong>
                    (through <?php echo e($renewalDateEnd->format('d M Y')); ?>).
                    Pick a product type, then use <strong>Manage</strong> to email or SMS clients and create tickets.
                    <?php if($isDemoRenewals ?? false): ?>
                        <span class="badge bg-warning text-dark ms-1">Demo data</span>
                    <?php endif; ?>
                </p>
                <div class="mat-hero-links d-flex flex-wrap gap-3">
                    <a href="<?php echo e(route('support.maturities')); ?>"><i class="bi bi-calendar2-event me-1"></i>Maturing policies</a>
                    <a href="<?php echo e(route('support.investment-maturities')); ?>"><i class="bi bi-piggy-bank me-1"></i>Investment maturities</a>
                    <a href="<?php echo e(route('support.customers')); ?>"><i class="bi bi-people me-1"></i>Clients</a>
                </div>
            </div>
        </div>
        <?php if((($mortgageConfigured ?? false) && ($useHttp ?? false) && ! ($pageError ?? null)) || ($isDemoRenewals ?? false)): ?>
            <a href="<?php echo e(route('support.mortgage-renewals.export', request()->only(['window', 'search', 'product']))); ?>" class="btn btn-light btn-sm fw-semibold d-inline-flex align-items-center gap-1 shadow-sm" title="Download all rows in this period as Excel">
...
<div class="row g-3 mb-4">
    <div class="col-6 col-lg-3">
        <div class="mat-stat-card">
            ...
            <p class="text-muted small mb-0 mt-1">Next <?php echo e($window); ?> days</p>
        </div>
    </div>
    <div class="col-6 col-lg-3">
        <div class="mat-stat-card">
            ...
            <div class="mat-stat-value"><?php echo e(number_format($stats['today'])); ?></div>
    ...
    <div class="col-6 col-lg-3">
        <div class="mat-stat-card">
            ...
            <div class="mat-stat-value"><?php echo e(number_format($stats['this_week'])); ?></div>
    ...
    <div class="col-6 col-lg-3">
        <div class="mat-stat-card">
            ...
            <div class="mat-stat-value"><?php echo e(number_format($stats['pending_notify'])); ?></div>
...
<div class="mat-toolbar mb-3">
    <div class="d-flex flex-wrap align-items-end gap-3">
        <form method="GET" action="<?php echo e(route('support.mortgage-renewals')); ?>" class="d-flex flex-column gap-1">
            <?php $__currentLoopData = request()->except(['product', 'page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <select name="product" class="form-select form-select-sm" style="min-width:11rem" onchange="this.form.submit()">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" <?php echo e($product === $key ? 'selected' : ''); ?>><?php echo e($meta['label']); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </form>
        <form method="GET" action="<?php echo e(route('support.mortgage-renewals')); ?>" class="d-flex flex-column gap-1">
            <?php $__currentLoopData = request()->except(['window', 'page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($v !== null && $v !== ''): ?> <input type="hidden" name="<?php echo e($k); ?>" value="<?php echo e($v); ?>"> <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <select name="window" class="form-select form-select-sm" style="min-width:11rem" onchange="this.form.submit()">
                <?php $__currentLoopData = \App\Http\Controllers\MortgageRenewalController::RENEWAL_WINDOWS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($w); ?>" <?php echo e($window === $w ? 'selected' : ''); ?>><?php echo e($w); ?> days</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </form>
        <form method="GET" action="<?php echo e(route('support.mortgage-renewals')); ?>" class="d-flex flex-column gap-1 mat-search-wide">
            ...
            <div class="input-group input-group-sm">
                ...
                <input type="search" name="search" class="form-control border-start-0" placeholder="Policy, client, product, email, phone…" value="<?php echo e($search); ?>" aria-label="Search">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 mt-3 pt-3 border-top">
        ...
        <a href="<?php echo e(route('support.mortgage-renewals', request()->except(['search', 'page']))); ?>" class="mat-filter-chip">
            Search: <?php echo e(\Illuminate\Support\Str::limit($search, 24)); ?> <i class="bi bi-x"></i>
        </a>
        <a href="<?php echo e(route('support.mortgage-renewals', ['window' => $window, 'product' => $product])); ?>" class="small text-muted ms-auto">Clear all</a>
    </div>
    <?php endif; ?>
</div>
...
<?php if($pageError ?? null): ?>
    <div class="alert alert-warning alert-dismissible fade show mb-4 d-flex align-items-start gap-2" role="alert">
        ...
        <div class="flex-grow-1"><?php echo e($pageError); ?></div>
        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
    </div>
<?php endif; ?>
...
<div class="app-card mat-table-card shadow-sm">
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <tr class="<?php echo e($urgencyClass); ?>">
                        <td><span class="mat-policy-no"><?php echo e($rowPolicy !== '' ? $rowPolicy : '—'); ?></span></td>
                        <td class="text-nowrap fw-medium"><?php echo e($renewStr); ?></td>
                        <td>
                            <?php if($daysToRenewal !== null): ?>
                                <?php if($daysToRenewal < 0): ?>
                                    <span class="mat-days-pill mat-days-pill--overdue"><i class="bi bi-exclamation-circle"></i> Overdue <?php echo e(abs($daysToRenewal)); ?>d</span>
                                <?php elseif($daysToRenewal === 0): ?>
                                    <span class="mat-days-pill mat-days-pill--today"><i class="bi bi-alarm"></i> Today</span>
                                <?php elseif($daysToRenewal <= 7): ?>
                                    <span class="mat-days-pill mat-days-pill--soon"><i class="bi bi-clock"></i> <?php echo e($daysToRenewal); ?> days</span>
                                <?php else: ?>
                                    <span class="mat-days-pill mat-days-pill--normal"><?php echo e($daysToRenewal); ?> days</span>
                                <?php endif; ?>
                            <?php else: ?>
                        ...
                        <td>
                            <span class="mat-client-name d-inline-block text-truncate" title="<?php echo e($clientName); ?>"><?php echo e($clientName); ?></span>
                        </td>
                        <td>
                            <?php if($productName !== ''): ?>
                                <span class="mat-product-badge" title="<?php echo e($productName); ?>"><?php echo e($productName); ?></span>
                            <?php else: ?>
                                <span class="text-muted">—</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if($st !== ''): ?>
                                <span class="badge <?php echo e($statusBadgeClass); ?>"><?php echo e($statusLabel($st)); ?></span>
                            <?php else: ?>
                                <span class="text-muted">—</span>
                            <?php endif; ?>
                        </td>
                        <td class="small">
                            <?php if($clientEmail): ?>
                                <div class="mat-contact-line"><i class="bi bi-envelope text-muted"></i><span class="text-truncate" style="max-width:160px" title="<?php echo e($clientEmail); ?>"><?php echo e($clientEmail); ?></span></div>
                            <?php endif; ?>
                            <?php if($clientPhone): ?>
                                <div class="mat-contact-line"><i class="bi bi-phone text-muted"></i><a href="tel:<?php echo e(tel_href($clientPhone)); ?>" class="text-decoration-none"><?php echo e($clientPhone); ?></a></div>
                            <?php endif; ?>
                        ...
                        <td>
                            <?php if($clientNotified): ?>
                                <div class="d-flex flex-wrap gap-1">
                                    <?php if(!empty($customer->client_notified_email)): ?>
                                        <span class="mat-notify-badge mat-notify-badge--done"><i class="bi bi-envelope-check"></i> Email</span>
                                    <?php endif; ?>
                                    <?php if(!empty($customer->client_notified_sms)): ?>
                        ...
                        <td class="text-end">
                            <?php if($rowPolicy !== '' && $renewYmd): ?>
                                <div class="mat-actions">
                                    <button type="button"
                                        class="btn btn-sm btn-primary mat-manage-btn mr-open-panel"
                                        data-bs-toggle="offcanvas"
                                        data-bs-target="#mortgageRenewalPanel"
                                        data-policy="<?php echo e($rowPolicy); ?>"
                                        data-renewal-ymd="<?php echo e($renewYmd); ?>"
                                        data-renewal-display="<?php echo e($renewStr); ?>"
                                        data-client-name="<?php echo e($clientName !== '—' ? $clientName : $rawClientName); ?>"
                                        data-product="<?php echo e($productName); ?>"
                                        data-email="<?php echo e($clientEmail); ?>"
                                        data-phone="<?php echo e($clientPhone); ?>"
                                        data-subject="<?php echo e($notifySubject); ?>"
                                        data-status="<?php echo e($statusLabel($st)); ?>"
                                        data-days="<?php echo e($daysToRenewal); ?>"
                                        data-email-sent="<?php echo e(! empty($customer->client_notified_email) ? '1' : '0'); ?>"
                                        data-sms-sent="<?php echo e(! empty($customer->client_notified_sms) ? '1' : '0'); ?>"
                                        title="Open full client actions">
                                        <i class="bi bi-sliders me-1"></i>Manage
                                    </button>
                                    <?php echo $__env->make('support.partials.maturity-notify-buttons', [
                    ...
                    <tr>
                        <td colspan="9" class="p-0 border-0">
                            <div class="mat-empty-state">
                                <div class="mat-empty-icon"><i class="bi <?php echo e($productIcon); ?>"></i></div>
                                <?php if($pageError ?? null): ?>
                                    <p class="text-muted mb-0">Resolve the message above and refresh.</p>
                                <?php elseif($hasActiveFilters): ?>
                                    <h6 class="fw-semibold mb-1">No matching <?php echo e(strtolower($productLabel)); ?> policies</h6>
                                    <p class="text-muted small mb-3">Try a different search term or clear your filters.</p>
                                    <a href="<?php echo e(route('support.mortgage-renewals', ['window' => $window, 'product' => $product])); ?>" class="btn btn-sm btn-outline-primary">Clear filters</a>
                                <?php else: ?>
                                    <h6 class="fw-semibold mb-1">All clear for now</h6>
                                    <p class="text-muted small mb-0">No <?php echo e(strtolower($productLabel)); ?> policies with a renewal in the next <?php echo e($window); ?> days.</p>
                                <?php endif; ?>
                            </div>
                        </td>
                    </tr>
    ...
    <?php if(($customers->total() ?? 0) > 0): ?>
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 px-3 py-3 border-top bg-light">
            <div class="d-flex align-items-center gap-2 flex-wrap">
                <span class="small text-muted">
                    Showing <strong><?php echo e($customers->firstItem() ?? 0); ?>–<?php echo e($customers->lastItem() ?? 0); ?></strong>
                    of <strong><?php echo e(number_format($customers->total())); ?></strong>
                </span>
                <form method="GET" action="<?php echo e(route('support.mortgage-renewals')); ?>" class="d-inline">
                    ...
                    <select name="per_page" class="form-select form-select-sm" style="width:auto" onchange="this.form.submit()">
                        <?php $__currentLoopData = [25, 50, 100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($n); ?>" <?php echo e(($perPage ?? 25) == $n ? 'selected' : ''); ?>><?php echo e($n); ?> / page</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </form>
            </div>
...
<details class="mat-footer-note mt-3 mb-0">
    ...
    <p class="text-muted small mt-2 mb-0">
        This list shows <?php echo e(strtolower($productLabel)); ?> policies whose <strong>renewal date</strong> falls between today and <?php echo e($renewalDateEnd->format('d M Y')); ?> — not the full register.
        ...
        <?php if($product === 'group'): ?>
            Group / mortgage clients: <a href="<?php echo e(route('support.customers', ['system' => 'group'])); ?>">Support → Clients → Group Life</a>
            or <a href="<?php echo e(route('support.customers', ['system' => 'mortgage'])); ?>">Mortgage</a>.
        <?php elseif($product === 'individual'): ?>
            Individual clients: <a href="<?php echo e(route('support.customers', ['system' => 'individual'])); ?>">Support → Clients → Individual Life</a>.
        <?php elseif($product === 'pension'): ?>
            Group pension clients: <a href="<?php echo e(route('support.customers', ['system' => 'group_pension'])); ?>">Support → Clients → Group Pension</a>.
        <?php endif; ?>
    </p>
</details>

<?php echo $__env->make('support.partials.maturity-notify-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('support.partials.mortgage-renewal-panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/support/mortgage-renewals.blade.php ENDPATH**/ ?>