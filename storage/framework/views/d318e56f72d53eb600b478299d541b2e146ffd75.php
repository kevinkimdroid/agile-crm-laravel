...
?>
<?php if($staffBannerEnabled): ?>
<div
    id="dashboardStaffBanner"
    class="dashboard-staff-banner dashboard-staff-banner--<?php echo e($staffBannerVariant); ?>"
    data-banner-id="<?php echo e($staffBanner['id'] ?? 'default'); ?>"
    role="status"
    aria-live="polite"
    hidden
>
    <div class="dashboard-staff-banner-icon" aria-hidden="true">
        <?php if($staffBannerVariant === 'warning'): ?>
            <i class="bi bi-exclamation-triangle-fill"></i>
        <?php elseif($staffBannerVariant === 'success'): ?>
    ...
    <div class="dashboard-staff-banner-body">
        <p class="dashboard-staff-banner-title"><?php echo e($staffBanner['title'] ?? 'Notice for staff'); ?></p>
        <p class="dashboard-staff-banner-message"><?php echo nl2br(e($staffBannerMessage)); ?></p>
        <?php if($staffBannerShowLink): ?>
            <a href="<?php echo e($staffBannerLinkUrl); ?>" class="dashboard-staff-banner-link" target="_blank" rel="noopener noreferrer">
                <?php echo e($staffBannerLinkLabel !== '' ? $staffBannerLinkLabel : 'Learn more'); ?>
...
.dashboard-staff-banner--info .dashboard-staff-banner-icon {
    background: color-mix(in srgb, <?php echo e(config('branding.primary')); ?> 14%, white);
    color: <?php echo e(config('branding.primary')); ?>;
}
...
.dashboard-staff-banner-link:hover { color: <?php echo e(config('branding.accent')); ?>; text-decoration: underline; }
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/partials/dashboard-staff-banner.blade.php ENDPATH**/ ?>