...
<div class="modal fade" id="maturityNotifyModal" tabindex="-1" aria-labelledby="maturityNotifyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="post" action="<?php echo e(route('support.maturities.notify-client')); ?>" id="maturityNotifyForm">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="return_url" id="mn_return_url" value="<?php echo e(request()->fullUrl()); ?>">
...
(function () {
    ...
    modal.addEventListener('show.bs.modal', function (event) {
        ...
        if (policy && (needsEmail || needsPhone)) {
            ...
            fetch(<?php echo json_encode(route('support.maturities.client-contact'), 15, 512) ?> + '?policy=' + encodeURIComponent(policy), {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/support/partials/maturity-notify-modal.blade.php ENDPATH**/ ?>