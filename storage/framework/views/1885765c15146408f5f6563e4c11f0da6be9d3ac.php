<?php $__env->startSection('title', 'Email & SMS broadcast'); ?>
...
<div class="bc-page">
    <div class="bc-hero mb-3">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            ...
            <div class="d-flex flex-wrap gap-2 bc-hero-stats">
                <span class="bc-chip"><strong><?php echo e(number_format($customerList->count())); ?></strong> people
                    <?php if($duplicatesCollapsed > 0): ?>
                        <span class="opacity-75">· <?php echo e(number_format($duplicatesCollapsed)); ?> merged</span>
                    <?php elseif($totalMatching > $customerList->count()): ?>
                        <span class="opacity-75">of <?php echo e(number_format($totalMatching)); ?></span>
                    <?php endif; ?>
                </span>
                <span class="bc-chip bc-chip-email"><i class="bi bi-envelope"></i> <?php echo e(number_format($withEmailCount)); ?> email</span>
                <span class="bc-chip bc-chip-sms"><i class="bi bi-phone"></i> <?php echo e(number_format($withPhoneCount)); ?> phone</span>
    ...
    <?php endif; ?>
    <?php if(!empty($broadcastLifeSegmentNeedsErp)): ?>
    ...
    <?php endif; ?>
    <?php if(empty($broadcastHistoryReady)): ?>
    ...
    <form method="GET" action="<?php echo e(route('marketing.broadcast')); ?>" id="bcFilterForm" class="bc-filter-bar mb-3">
        <div class="row g-2 align-items-end">
            <div class="col-md-4">
                ...
                <input type="search" name="search" id="bcSearchInput" class="form-control form-control-sm"
                    value="<?php echo e($search ?? ''); ?>" placeholder="Name, policy, email, or phone">
            </div>
            <div class="col-md-4">
                ...
                <select name="client_type" id="bcClientTypeFilter" class="form-select form-select-sm">
                    <option value="all" <?php echo e(($clientType ?? 'all') === 'all' ? 'selected' : ''); ?>>All contacts</option>
                    <?php if(!empty($broadcastUsesErpClients) && !empty($lifeSystemOptions)): ?>
                        <optgroup label="Support → Clients">
                            <?php $__currentLoopData = $lifeSystemOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($opt['value']); ?>" <?php echo e(($clientType ?? '') === $opt['value'] ? 'selected' : ''); ?>><?php echo e($opt['label']); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </optgroup>
                    <?php endif; ?>
                    <?php $__currentLoopData = $recordSources ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $src): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $sv = 's|' . $src; ?>
                        <option value="<?php echo e($sv); ?>" <?php echo e(($clientType ?? '') === $sv ? 'selected' : ''); ?>>Record source: <?php echo e($src); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $contactTypeValues ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $tvv = 't|' . $tv; ?>
                        <option value="<?php echo e($tvv); ?>" <?php echo e(($clientType ?? '') === $tvv ? 'selected' : ''); ?>>Vtiger field: <?php echo e($tv); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-md-2">
                ...
                <select name="limit" id="bcListLimit" class="form-select form-select-sm">
                    <?php $__currentLoopData = [250, 500, 1000]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($n <= $listMax): ?>
                            <option value="<?php echo e($n); ?>" <?php echo e((string) $listLimit === (string) $n ? 'selected' : ''); ?>><?php echo e(number_format($n)); ?></option>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <option value="all" <?php echo e($listLimit === 'all' ? 'selected' : ''); ?>>All</option>
                </select>
            </div>
            <div class="col-md-2 d-flex gap-2">
                <button type="submit" class="btn btn-sm btn-primary-custom flex-grow-1">Show</button>
                <?php if($hasListFilters): ?>
                    <a href="<?php echo e(route('marketing.broadcast')); ?>" class="btn btn-sm btn-outline-secondary" title="Clear filters">
        ...
        <div class="d-flex flex-wrap gap-3 mt-2">
            <div class="form-check form-switch mb-0">
                <input type="checkbox" class="form-check-input" name="hide_list_email_recent" value="1" id="hideListEmailRecent"
                    <?php echo e(!empty($hideListEmailRecent) ? 'checked' : ''); ?> <?php echo e(empty($broadcastHistoryReady) ? 'disabled' : ''); ?>>
            ...
            <div class="form-check form-switch mb-0">
                <input type="checkbox" class="form-check-input" name="hide_list_sms_recent" value="1" id="hideListSmsRecent"
                    <?php echo e(!empty($hideListSmsRecent) ? 'checked' : ''); ?> <?php echo e(empty($broadcastHistoryReady) ? 'disabled' : ''); ?>>
                <label class="form-check-label small" for="hideListSmsRecent">Hide recent SMS</label>
            </div>
        </div>
    </form>

    <form method="POST" action="<?php echo e(route('marketing.broadcast.send')); ?>" id="broadcastForm" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="search" value="<?php echo e($search ?? ''); ?>">
        <input type="hidden" name="client_type" id="bcSendClientType" value="<?php echo e(old('client_type', $clientType ?? 'all')); ?>">
        <?php if(($listLimit ?? 'all') !== 'all'): ?>
            <input type="hidden" name="limit" value="<?php echo e($listLimit); ?>">
        <?php endif; ?>
        <?php if(!empty($hideListEmailRecent)): ?>
            <input type="hidden" name="hide_list_email_recent" value="1">
        <?php endif; ?>
        <?php if(!empty($hideListSmsRecent)): ?>
        ...
        <div class="bc-channel-cards mb-3" role="tablist">
            <button type="button" class="bc-channel-card bc-channel-card-email active" id="tab-email"
                ...
                <span class="bc-channel-card-badge"><?php echo e(number_format($withEmailCount)); ?> ready</span>
            </button>
            <button type="button" class="bc-channel-card bc-channel-card-sms" id="tab-sms"
                ...
                <span class="bc-channel-card-badge"><?php echo e(number_format($withPhoneCount)); ?> ready</span>
            </button>
        </div>
                    ...
                    <div class="card bc-card bc-composer-card bc-letter-card">
                        <div class="card-body p-0">
                            ...
                            <div class="bc-tpl-bar mb-3">
                                <select id="bcEmailTemplateSelect" class="form-select form-select-sm" <?php echo e($emailTplEmpty ? 'disabled' : ''); ?>>
                                    <option value="">Email template…</option>
                                    <?php $__currentLoopData = $emailTplList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tpl->id); ?>"><?php echo e($tpl->template_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <button type="button" class="btn btn-sm btn-outline-primary" id="bcApplyEmailTemplate" <?php echo e($emailTplEmpty ? 'disabled' : ''); ?>>Use</button>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="subject" id="broadcastSubject" class="form-control bc-email-field"
                                    value="<?php echo e(old('subject')); ?>" maxlength="200" placeholder="e.g. Important update from Kenya Orient">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <textarea name="body" id="broadcastBody" class="form-control bc-email-field bc-letter-body" rows="7"
                                placeholder="Write like a letter. Insert first name or full name below."><?php echo e(old('body')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            <div class="d-flex flex-wrap gap-1 mt-2 mb-2">
                                <?php $__currentLoopData = $emailMergeTokens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" class="btn btn-sm bc-token-chip bc-insert-token" data-target="broadcastBody" data-token="<?php echo e($tok['token']); ?>"><?php echo e($tok['label']); ?></button>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                ...
                <div class="tab-pane fade" id="pane-sms" role="tabpanel">
                    ...
                    <div class="card bc-card bc-composer-card bc-sms-card">
                        <div class="card-body p-3">
                            <div class="bc-tpl-bar mb-3">
                                <select id="bcSmsTemplateSelect" class="form-select form-select-sm" <?php echo e($smsTplEmpty ? 'disabled' : ''); ?>>
                                    <option value="">SMS template…</option>
                                    <?php $__currentLoopData = $smsTplList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tpl->id); ?>"><?php echo e($tpl->template_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <button type="button" class="btn btn-sm btn-outline-success" id="bcApplySmsTemplate" <?php echo e($smsTplEmpty ? 'disabled' : ''); ?>>Use</button>
                            ...
                            <textarea name="message" id="broadcastSmsMessage" class="form-control bc-sms-field" rows="6" maxlength="1600"
                                placeholder="Keep it short. Long texts split into extra SMS."><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            <div class="d-flex flex-wrap gap-1 mt-2 mb-3">
                                <?php $__currentLoopData = $smsMergeTokens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" class="btn btn-sm bc-token-chip bc-insert-token" data-target="broadcastSmsMessage" data-token="<?php echo e($tok['token']); ?>"><?php echo e($tok['label']); ?></button>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
            ...
            <div class="card bc-card">
                <div class="card-header bc-recipients-head">
                    <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                        ...
                        <span class="badge bg-light text-dark border" id="bcVisibleCount"><?php echo e($customerList->count()); ?> people</span>
                        <?php if($duplicatesCollapsed > 0): ?>
                            <span class="small text-muted"><?php echo e($duplicatesCollapsed); ?> duplicate<?php echo e($duplicatesCollapsed === 1 ? '' : 's'); ?> merged</span>
                        <?php elseif($totalMatching > $customerList->count()): ?>
                            <span class="small text-muted">of <?php echo e(number_format($totalMatching)); ?> matching</span>
                        <?php endif; ?>
                    </div>
                        ...
                        <table class="table mb-0 align-middle bc-recipients-table bc-people-cards">
                            ...
                            <tbody id="bcRecipientsBody">
                                <?php $__empty_1 = true; $__currentLoopData = $customerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    ?>
                                    <tr class="bc-row" data-has-email="<?php echo e($hasEm ? '1' : '0'); ?>" data-has-phone="<?php echo e($hasPh ? '1' : '0'); ?>"
                                        data-search="<?php echo e($searchBlob); ?>" tabindex="0" role="button" aria-label="Toggle <?php echo e($fullName); ?>">
                                        <td class="bc-person-cell" colspan="2">
                                            <div class="bc-person">
                                                <div class="bc-person-check" onclick="event.stopPropagation()">
                                                    <input type="checkbox" class="form-check-input bc-check" name="contact_ids[]" value="<?php echo e($c->contactid); ?>"
                                                        data-has-email="<?php echo e($hasEm ? '1' : '0'); ?>" data-has-phone="<?php echo e($hasPh ? '1' : '0'); ?>">
                                                </div>
                                                <div class="bc-avatar" style="--bc-hue: <?php echo e($hue); ?>"><?php echo e($ini); ?></div>
                                                <div class="bc-person-body">
                                                    <div class="bc-person-name">
                                                        <?php echo e($fullName); ?>

                                                        <?php if((int) ($c->duplicate_count ?? 0) > 0): ?>
                                                            <span class="bc-merged" title="<?php echo e((int) $c->duplicate_count); ?> duplicate record<?php echo e((int) $c->duplicate_count === 1 ? '' : 's'); ?> merged into this row">merged</span>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="bc-person-sub">
                                                        <?php if($policyNo !== ''): ?>
                                                            <span><?php echo e($policyNo); ?></span>
                                                        <?php endif; ?>
                                                        <?php if($product !== ''): ?>
                                                            <span><?php echo e(Str::limit($product, 28)); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="bc-person-reach">
                                                        <?php if($hasEm): ?>
                                                            <span title="<?php echo e($em); ?>"><i class="bi bi-envelope"></i> <?php echo e($em); ?></span>
                                                        <?php else: ?>
                                                            <span class="text-muted">No email</span>
                                                        <?php endif; ?>
                                                        <?php if($hasPh): ?>
                                                            <span><i class="bi bi-phone"></i> <?php echo e($ph); ?></span>
                                                        <?php endif; ?>
                                                        <?php if(!empty($broadcastHistoryReady) && !empty($lb['email'])): ?>
                                                            <span class="text-success" title="<?php echo e($lb['email']->format('Y-m-d H:i')); ?>">Last email <?php echo e($lb['email']->diffForHumans()); ?></span>
                                                        <?php endif; ?>
                                                        <?php if(!empty($broadcastHistoryReady) && !empty($lb['sms'])): ?>
                                                            <span class="text-success" title="<?php echo e($lb['sms']->format('Y-m-d H:i')); ?>">Last SMS <?php echo e($lb['sms']->diffForHumans()); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr class="bc-empty-row">
                                        <td colspan="2" class="text-center py-5">
                                            ...
                                            <?php if($hasListFilters): ?>
                                                <a href="<?php echo e(route('marketing.broadcast')); ?>" class="btn btn-sm btn-outline-primary">Clear filters</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                ...
                <div class="card-footer bc-people-footer">
                    ...
                    <a href="<?php echo e(route('marketing.broadcast.template')); ?>" class="btn btn-sm btn-outline-primary">Template</a>
                    <?php $__errorArgs = ['recipients_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback d-block"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-check form-switch mb-0">
                        <input type="checkbox" class="form-check-input" name="skip_recent_sends" id="skipRecentSends" value="1"
                            <?php echo e((string) old('skip_recent_sends', '1') !== '0' ? 'checked' : ''); ?>

                            <?php echo e(empty($broadcastHistoryReady) ? 'disabled' : ''); ?>>
                        <label class="form-check-label small" for="skipRecentSends">
                            Skip recent <span id="skipChannelLabel">email</span> (<?php echo e((int) ($skipRecentDays ?? 14)); ?> days)
                        </label>
                    </div>
                    <details class="small">
                        ...
                        <select class="form-select form-select-sm mt-2" id="bcSendClientTypeOverride">
                            ...
                            <?php $__currentLoopData = $recordSources ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $src): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $sv = 's|' . $src; ?>
                                <option value="<?php echo e($sv); ?>">Record source: <?php echo e($src); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $contactTypeValues ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $tvv = 't|' . $tv; ?>
                                <option value="<?php echo e($tvv); ?>">Vtiger field: <?php echo e($tv); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </details>
                </div>
    ...
    <details class="bc-tips mt-2">
        ...
        <ul class="small text-muted mb-0 mt-2 ps-3">
            ...
            <li>Keep <strong>Skip duplicate sends</strong> on to avoid messaging the same people twice within <?php echo e((int) ($skipRecentDays ?? 14)); ?> days.</li>
            <li>Max <?php echo e($maxRecipients ?? 500); ?> recipients per send — split larger lists into batches.</li>
        </ul>
    </details>
</div>
...
?>
<script type="application/json" id="bcEmailTemplatesById"><?php echo json_encode($emailTemplatesById, 15, 512) ?></script>
<script type="application/json" id="bcSmsTemplatesById"><?php echo json_encode($smsTemplatesById, 15, 512) ?></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var tplStoreUrl = <?php echo json_encode(route('marketing.broadcast.templates.store'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sites\agile-crm-laravel\resources\views/marketing/broadcast.blade.php ENDPATH**/ ?>